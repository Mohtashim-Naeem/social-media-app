import 'package:bloom_app/views_models/enrichment/video/enrichment_video_player_view_model.dart';
...
class EnrichmentVideoPlayerView extends StatelessWidget {
  const EnrichmentVideoPlayerView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: EnrichmentVideoPlayerViewModel(),
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
              title: Text(
